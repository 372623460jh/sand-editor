...
type BackColorIconProps = {
  fill?: string;
  stroke?: string;
};

// React.SFC 以便将其理解为React无状态功能组件
const BackColorIcon: React.SFC<BackColorIconProps> = (
  props: BackColorIconProps
) => {
